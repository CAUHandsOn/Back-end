package cau.handson.business.constant;
...
public enum Code {
    ...
    EMAIL_FORMAT_ERROR(2106, HttpStatus.BAD_REQUEST, "Email format error"),
    EMAIL_DUPLICATED(2107, HttpStatus.BAD_REQUEST, "Email address duplicated"),
    ...
    NOT_FOUND(4102, HttpStatus.BAD_REQUEST, "Cannot find data"),
